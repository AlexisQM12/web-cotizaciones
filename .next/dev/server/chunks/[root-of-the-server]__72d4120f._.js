...
"[project]/src/lib/firestore.js [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$firestore$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/src/lib/firestore.js [app-route] (ecmascript)");
var __turbopack_async_dependencies__ = __turbopack_handle_async_dependencies__([
    __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$firestore$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__
]);
[__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$firestore$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__] = __turbopack_async_dependencies__.then ? (await __turbopack_async_dependencies__)() : __turbopack_async_dependencies__;
;
async function POST(req) {
    try {
        ...
        // Count only published quotations from current year
        const snapshot = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$firestore$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"].collection('quotations').where('isPublished', '==', true).where('createdAt', '>=', yearStart).where('createdAt', '<=', yearEnd).get();
        ...
        await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$firestore$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"].collection('quotations').doc(quotationId).update({
            code,
            isPublished: true,
            status: 'published',
...
//# sourceMappingURL=%5Broot-of-the-server%5D__72d4120f._.js.map