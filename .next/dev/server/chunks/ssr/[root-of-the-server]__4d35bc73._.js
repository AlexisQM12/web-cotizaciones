...
function AuthProvider({ children }) {
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useEffect"])(()=>{
        const unsubscribe = onAuthStateChanged(__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$firebaseConfig$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["auth"], async (firebaseUser)=>{
            if (firebaseUser) {
                // User is signed in
                const userData = {
    ...
    const signInWithGoogle = async ()=>{
        try {
            ...
            const result = await signInWithPopup(__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$firebaseConfig$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["auth"], provider);
            return result.user;
        } catch (error) {
    ...
    const signOut = async ()=>{
        try {
            await firebaseSignOut(__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$firebaseConfig$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["auth"]);
        } catch (error) {
...
//# sourceMappingURL=%5Broot-of-the-server%5D__4d35bc73._.js.map