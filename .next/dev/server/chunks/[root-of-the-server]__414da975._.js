...
"[project]/src/app/api/company-profiles/[id]/route.js [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
async function GET(req, { params }) {
    try {
        ...
        const doc = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$firebase$2d$admin$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__$3c$locals$3e$__["firestore"].collection('company_profiles').doc(id).get();
...
async function PUT(req, { params }) {
    try {
        ...
        const docRef = __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$firebase$2d$admin$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__$3c$locals$3e$__["firestore"].collection('company_profiles').doc(id);
        batch.update(docRef, {
            name,
            address,
            email,
...
async function DELETE(req, { params }) {
    try {
        const { id } = await params;
        await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$firebase$2d$admin$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__$3c$locals$3e$__["firestore"].collection('company_profiles').doc(id).delete();
        return Response.json({
            success: true
        });
    } catch (error) {
...
//# sourceMappingURL=%5Broot-of-the-server%5D__414da975._.js.map