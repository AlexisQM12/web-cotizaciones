...
export async function GET(req) {
    try {
        ...
        const [salesSnap, purchasesSnap] = await Promise.all([
            getTenantCollection((typeof empresaId !== 'undefined' ? empresaId : (typeof companyProfileId !== 'undefined' && companyProfileId ? companyProfileId : 'ayatech')), 'sales_ledger').where('companyProfileId', '==', companyProfileId).get(),
            getTenantCollection((typeof empresaId !== 'undefined' ? empresaId : (typeof companyProfileId !== 'undefined' && companyProfileId ? companyProfileId : 'ayatech')), 'purchases_ledger').where('companyProfileId', '==', companyProfileId).get(),
        ]);
