...
export async function GET(req) {
    try {
        ...
        let query = getTenantCollection(empresaId, 'client_profiles');
        if (empresaId) {
...
export async function POST(req) {
    try {
        ...
        if (isDefault && empresaId) {
            const defaultQuery = await getTenantCollection(empresaId, 'client_profiles')
        ...
        const newProfileRef = getTenantCollection(empresaId, 'client_profiles').doc();
